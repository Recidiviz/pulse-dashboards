 ...
 * VITE_PUBLIC_PATHWAYS_SENTRY_DSN and VITE_PUBLIC_PATHWAYS_SENTRY_ENV. If VITE_PUBLIC_PATHWAYS_SENTRY_ENV is not "production",
 * errors will be logged to the console.
 */
export function initializeSentry(): void {
  const dsn = import.meta.env["VITE_PUBLIC_PATHWAYS_SENTRY_DSN"];
  const environment =
    import.meta.env["VITE_PUBLIC_PATHWAYS_SENTRY_ENV"] ?? "development";
