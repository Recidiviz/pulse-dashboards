...
export const DEFAULT_REPORTED_VIOLATIONS = [
  "all",
  "0",
  "1",
  "2",
...
export const DEFAULT_GENDERS = ["external_unknown", "female", "male", "other"];

export const DEFAULT_METRIC_PERIOD_MONTHS = ["1", "12", "3", "36", "6"];
...
export function removeAllValue(dimensionValues) {
