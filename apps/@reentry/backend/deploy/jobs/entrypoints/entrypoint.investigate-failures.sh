...
echo "Starting investigation of execution failures..."
...
echo "Running investigation of execution failures..."
uv run python -m app.manage investigate-execution-failures
