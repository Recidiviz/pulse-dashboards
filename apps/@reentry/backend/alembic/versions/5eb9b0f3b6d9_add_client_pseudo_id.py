"""add client_pseudo_id

Revision ID: 5eb9b0f3b6d9
Revises: 5131a8c909b9
Create Date: 2025-09-02 19:04:19.830613
...
def upgrade() -> None:
    ...
    op.add_column('assessment', sa.Column('client_pseudo_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    op.alter_column('assessment', 'client_id',
               existing_type=sa.VARCHAR(),
               nullable=True)
    op.add_column('intake', sa.Column('client_pseudo_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    op.alter_column('intake', 'client_id',
               existing_type=sa.VARCHAR(),
               nullable=True)
    op.add_column('plan', sa.Column('client_pseudo_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    op.alter_column('plan', 'client_id',
               existing_type=sa.VARCHAR(),
               nullable=True)
    op.add_column('recording_session', sa.Column('client_pseudo_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    op.alter_column('recording_session', 'client_id',
               existing_type=sa.VARCHAR(),
               nullable=True)
...
def downgrade() -> None:
    ...
    op.alter_column('recording_session', 'client_id',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.drop_column('recording_session', 'client_pseudo_id')
    op.alter_column('plan', 'client_id',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.drop_column('plan', 'client_pseudo_id')
    op.alter_column('intake', 'client_id',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.drop_column('intake', 'client_pseudo_id')
    op.alter_column('assessment', 'client_id',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.drop_column('assessment', 'client_pseudo_id')
