...
class RedisKeys:
    ...
    @staticmethod
    def client_connection(client_id: str) -> str:
        """Key for client connection tracking."""
        return f"connections:{client_id}"
    ...
    @staticmethod
    def client_session(client_id: str) -> str:
        """Key for client session data."""
        return f"client_session:{client_id}"

    @staticmethod
    def waiting_for_response(client_id: str) -> str:
        """Key for tracking if waiting for user response."""
        return f"waiting_for_response:{client_id}"

    @staticmethod
    def waiting_response_data(client_id: str) -> str:
        """Key for storing waiting response data."""
        return f"waiting_response:{client_id}"
