  ...
  <div className={styles["noteContainer"]}>
    <div className={styles["noteCard"]}>
      ...
      <div className={styles["noteTwoBody"]}>
        ...
        <div className={styles["section"]}>
          <h3 className={styles["sectionTitle"]}>Who will see my responses?</h3>
          <p className={styles["sectionText"]}>
        ...
        <div className={styles["section"]}>
          <h3 className={styles["sectionTitle"]}>Important things to know:</h3>
          <ul className={styles["list"]}>
            ...
            <li className={styles["listItem"]}>
              ...
              <p>
                ...
                questions might require careful thought. Feel free to pause and
                reflect as much as you need.
              </p>
            </li>
            <li className={styles["listItem"]}>
              <span className={styles["bullet"]} />
            ...
            <li className={styles["listItem"]}>
              ...
              <p>
                ...
                intake should be completed before your re-entry to help develop
                a plan. The sooner you can finish it, the better.
              </p>
            </li>
          </ul>
        </div>
