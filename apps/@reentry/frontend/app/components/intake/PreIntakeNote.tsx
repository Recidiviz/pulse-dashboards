					...
					<div className="flex-1 flex items-center justify-center">
						<div className="space-y-6 text-black text-center font-['Public_Sans'] text-[18px] leading-[1.2] tracking-[-0.02em] max-w-[520px] mx-auto">
							<p>
								...
								probation officer learn more about your reentry goals, plans,
								and needs. The helps them start thinking about the best ways to
...
export { PreIntakeNoteOne, PreIntakeNoteTwo };
