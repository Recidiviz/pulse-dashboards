...
const getStateName = (stateCode: string): string => {
	// Extract the state code part after "US_"
	const cleanStateCode = stateCode?.startsWith("US_")
		? stateCode.substring(3)
		: stateCode;
	...
	return stateMap[cleanStateCode?.toUpperCase()] || stateCode || "Unknown";
};
								...
								{intake ? (
									<>
										...
										>
											...
											<p className="italic text-[13px]">
												...
												business days to appear in the resident&#39;s Edovo app
												after you enable the intake here.
											</p>
										</Typography>
									</>
								) : (
									<div className="text-center py-8">
										...
										<div className="text-center text-[14px] font-medium leading-[120%] tracking-[-0.01em] text-[#2B5469D9] font-['Public_Sans'] mt-3">
											Once enabled, the client will be able to access the intake
											assessment via computer lab or tablet.
										</div>
									</div>
								)}
							</div>
