...
import AdminIntakeHistory from "~@reentry/frontend/(protected)/clients/intake/[id]/chat-history/AdminIntakeHistory";
import AdminIntakeHistoryV2 from "~@reentry/frontend/(protected)/clients/intake/[id]/chat-history/AdminIntakeHistoryV2";
            ...
            <div className="w-full p-6 md:p-14 flex-col justify-start items-center gap-2 inline-flex bg-[#f9fafa] h-[calc(100vh-65px)]">
                ...
                {clientData.state_code === "US_AZ" ? (
                        <div className="flex items-center justify-center h-full text-gray-500 p-0 md:p-10 mb-6  w-full max-w-7xl">
                            Not chat history available for arizona clients
                        </div>
                    )
                    :(
