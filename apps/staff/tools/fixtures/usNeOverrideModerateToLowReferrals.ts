...
export const usNeOverrideModerateToLowReferrals = fixtureWithIdKey<
      ...
      "Latest Case Plan Check-in": [
        {
          ...
          noteBody:
            "Client has completed 40 hours of required 80 hours community service. Maintains dual employment with Lincoln Electric System and Weekend Auto Repair. No contact violations reported.",
          eventDate: relativeFixtureDate({ days: -12 }),
        },
        {
          noteTitle: "Employment Stability Review",
          noteBody:
            "Client successfully managing two employment positions. No issues reported by either employer. Shows strong work ethic and reliability.",
      ...
      "Special Conditions Monitoring": [
        {
          ...
          noteBody:
            "Verified no contact with co-defendants through regular monitoring. Client continues to comply with all no-contact requirements.",
      ...
      "Latest Case Plan Check-in": [
        {
          ...
          noteBody:
            "Client passes all random drug tests. Maintains stable residence at North Platte location. Successfully completed anger management counseling program. Employment with Union Pacific Railroad remains stable.",
          eventDate: relativeFixtureDate({ days: -6 }),
        },
        {
          noteTitle: "Progress Assessment",
          noteBody:
            "Client shows continued improvement in behavior and compliance. No violations in past 6 months. Demonstrating strong commitment to rehabilitation.",
      ...
      "Employment Verification": [
        {
          ...
          noteBody:
            "Contacted supervisor at Union Pacific Railroad. Client maintains good standing with company, reliable attendance, and satisfactory performance.",
