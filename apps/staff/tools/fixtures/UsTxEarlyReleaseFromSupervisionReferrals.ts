...
import { UsTxEarlyReleaseFromSupervisionRecord } from "~datatypes";

import { fixtureWithIdKey } from "./utils";

export const usTxEarlyReleaseFromSupervisionReferralsFixture = fixtureWithIdKey<
  UsTxEarlyReleaseFromSupervisionRecord["input"]
>("externalId", [
  // ── Eligible Now ───────────────────────────────────────────────────────
  {
    externalId: "002",
