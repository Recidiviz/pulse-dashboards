...
export const usNeConditionalLowRiskOverrideReferrals = fixtureWithIdKey<
  UsNeSupervisionDowngradeRecord["input"]
>("externalId", [
  {
    stateCode: "US_NE",
    externalId: "NE001",
      ...
      "Latest Case Plan Check-in": [
        {
          ...
          noteBody:
            "Client has successfully completed substance abuse treatment program. Employment status remains stable with Nebraska Medical Center. All special conditions are being met.",
          eventDate: relativeFixtureDate({ days: -5 }),
        },
        {
          noteTitle: "Progress Update",
          noteBody:
            "Client continues to demonstrate positive progress. No violations reported. Discussed upcoming discharge planning.",
      ...
      "General Contact": [
        {
          ...
          noteBody:
            "Conducted home visit - residence is stable and appropriate. Client was present and cooperative.",
      ...
      "Latest Case Plan Check-in": [
        {
          ...
          noteBody:
            "Client attended all scheduled mental health counseling sessions. Therapist reports good progress and engagement. Client demonstrates improved coping strategies.",
          eventDate: relativeFixtureDate({ days: -7 }),
        },
        {
          noteTitle: "Stability Assessment",
          noteBody:
            "Long-term supervision shows consistent compliance. Client has maintained stable housing and employment at Central Nebraska Community College.",
      ...
      "Employment Verification": [
        {
          ...
          noteBody:
            "Verified employment with Central Nebraska Community College. Supervisor reports excellent attendance and performance.",
      ...
      "Latest Case Plan Check-in": [
        {
          ...
          noteBody:
            "Client has maintained compliance throughout supervision period. No special conditions currently required. Employment with Great Plains Health remains stable.",
      ...
      "General Contact": [
        {
          ...
          noteBody:
            "Client reports continued stability. Discussed upcoming supervision completion and discharge planning.",
