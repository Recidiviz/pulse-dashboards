...
import { relativeFixtureDate, type UsAzReleaseToDTPRecord } from "~datatypes";

import { fixtureWithIdKey } from "./utils";

export const usAzReleaseToDTPReferrals = fixtureWithIdKey<
  UsAzReleaseToDTPRecord["input"]
>("externalId", [
