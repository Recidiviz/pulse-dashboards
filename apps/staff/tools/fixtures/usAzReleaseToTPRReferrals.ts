...
import { relativeFixtureDate, type UsAzReleaseToTPRRecord } from "~datatypes";

import { fixtureWithIdKey } from "./utils";

export const usAzReleaseToTPRReferrals = fixtureWithIdKey<
  UsAzReleaseToTPRRecord["input"]
>("externalId", [
