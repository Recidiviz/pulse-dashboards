...
import { UsTxAnnualReportStatusRecord } from "~datatypes";

import { fixtureWithIdKey } from "./utils";

export const usTxAnnualReportStatusReferralsFixture = fixtureWithIdKey<
  UsTxAnnualReportStatusRecord["input"]
>("externalId", [
  // ── Eligible Now ─────────────────────────────────────────────────────────
  {
    externalId: "002",
