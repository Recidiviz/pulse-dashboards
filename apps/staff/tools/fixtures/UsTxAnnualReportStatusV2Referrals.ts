...
import { UsTxAnnualReportStatusV2Record } from "~datatypes";

import { fixtureWithIdKey } from "./utils";

export const usTxAnnualReportStatusV2ReferralsFixture = fixtureWithIdKey<
  UsTxAnnualReportStatusV2Record["input"]
>("externalId", [
  // ── Eligible Now ─────────────────────────────────────────────────────────
  {
    externalId: "002",
