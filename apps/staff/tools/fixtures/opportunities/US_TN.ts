...
export const mockApiOpportunityConfigurationResponse = {
  enabledConfigs: {
    ...
    usTnAnnualReclassification2026Policy: {
      ...
      dynamicEligibilityText:
        "resident[|s] [is|are] eligible for their annual reclassification [2026 Pilot]",
      eligibilityDateText: null,
      eligibleCriteriaCopy: [
        {
          key: "usTnAtLeast12MonthsSinceLatestAssessment",
      ...
      emptyTabCopy: [],
      firestoreCollection: "US_TN-annualReclassification2026PolicyReferrals",
      hideDenialRevert: false,
      highlightCasesOnHomepage: false,
      highlightedCaseCtaCopy: null,
      homepagePosition: 9,
      ...
      strictlyIneligibleCriteriaCopy: [
        {
          key: "usTnAtLeast12MonthsSinceLatestAssessment",
          text: "Last reclassification date within the last 12 month",
        },
        { key: "custodyLevelIsNotMax", text: "Custody level is maximum" },
      ],
      subcategoryHeadings: [],
      subcategoryOrderings: [],
      subheading:
      ...
      tabPrefaceCopy: [],
      tooltipEligibilityText: null,
      urlSection: "annualReclassification2026Policy",
      zeroGrantsTooltip: null,
    },
    usTnAnnualReclassification2026PolicyV2: {
      ...
      denialText: null,
      deniedTabTitle: null,
      displayName: "[2026 Pilot V2] Annual Reclassification",
      dynamicEligibilityText:
        "resident[|s] [is|are] eligible for their annual reclassification [2026 Pilot V2]",
      eligibilityDateText: null,
      eligibleCriteriaCopy: [
        {
          key: "usTnAtLeast12MonthsSinceLatestAssessment",
      ...
      emptyTabCopy: [],
      firestoreCollection: "US_TN-annualReclassification2026PolicyV2Referrals",
      hideDenialRevert: false,
      highlightCasesOnHomepage: false,
      highlightedCaseCtaCopy: null,
      homepagePosition: 14,
      ...
      tabPrefaceCopy: [],
      tooltipEligibilityText: null,
      urlSection: "annualReclassification2026PolicyV2",
      zeroGrantsTooltip: null,
    },
    usTnCompliantReporting2025Policy: {
      ...
      denialNoun: null,
      denialReasons: [
        { key: "DECF", text: "DECF: Denied, No Effort to Pay Fine and Costs" },
        {
          key: "DECR",
          text: "DECR: Denied Compliant Report due to Criminal Record",
        },
        {
          key: "DECT",
          text: "DECT: Denied Compliant Reporting, Insufficient Time in Supervision Level",
        },
        { key: "DEDF", text: "DEDF: Denied, No Effort to Pay Fees" },
        { key: "DEDU", text: "DEDU: Denied, Serious Compliance Issues" },
        {
          key: "DEIJ",
          text: "DEIJ: Compliant Reporting Not Allowed Per Court",
        },
        { key: "DEIO", text: "DEIO: Denied for CR" },
        { key: "DEIR", text: "DEIR: Denied, Failure to Report as Instructed" },
        { key: "Other", text: "Other: please specify a reason" },
      ],
      denialText: null,
      deniedTabTitle: null,
    ...
    usTnCustodyLevelDowngrade2026Policy: {
      ...
      strictlyIneligibleCriteriaCopy: [
        ...
        {
          key: "usTnLatestCafAssessmentNotOverride",
          text: "Last assessment included an override",
        },
      ],
      subcategoryHeadings: [],
      subcategoryOrderings: [],
      ...
      tabPrefaceCopy: [],
      tooltipEligibilityText: null,
      urlSection: "custodyLevelDowngrade2026Policy",
      zeroGrantsTooltip: null,
    },
    usTnCustodyLevelDowngrade2026PolicyV2: {
      ...
      denialText: null,
      deniedTabTitle: null,
      displayName: "[2026 Pilot V2] Special Reclassification - Downgrade",
      dynamicEligibilityText:
        "resident[|s] may be eligible for a Special Downgrade [2026 Pilot V2]",
      eligibilityDateText: null,
      eligibleCriteriaCopy: [
        {
      ...
      tabPrefaceCopy: [],
      tooltipEligibilityText: null,
      urlSection: "custodyLevelDowngrade2026PolicyV2",
      zeroGrantsTooltip: null,
    },
    usTnExpiration: {
      callToAction:
    ...
    usTnInitialClassification2026Policy: {
      ...
      emptyTabCopy: [],
      firestoreCollection: "US_TN-initialClassification2026PolicyReferrals",
      hideDenialRevert: false,
      highlightCasesOnHomepage: false,
      highlightedCaseCtaCopy: null,
      homepagePosition: 10,
      ...
      strictlyIneligibleCriteriaCopy: [
        {
          key: "notHasInitialClassificationInStatePrisonCustody",
          text: "Already has initial classification on record",
        },
        { key: "custodyLevelIsNotMax", text: "Custody level is Max" },
      ],
      subcategoryHeadings: [],
      subcategoryOrderings: [],
      subheading:
      ...
      tabPrefaceCopy: [],
      tooltipEligibilityText: null,
      urlSection: "initialClassification2026Policy",
      zeroGrantsTooltip: null,
    },
    usTnSpecialCustodyLevelUpgrade2026Policy: {
      ...
      tabPrefaceCopy: [],
      tooltipEligibilityText: null,
      urlSection: "specialCustodyLevelUpgrade2026Policy",
      zeroGrantsTooltip: null,
    },
    usTnSpecialCustodyLevelUpgrade2026PolicyV2: {
      ...
      deniedTabTitle: null,
      displayName:
        "[2026 Pilot V2] Special Reclassification - Upgrade Due to Updated CAF Scoring",
      dynamicEligibilityText:
        "resident[|s] may need custody level reviewed under updated CAF [2026 Pilot V2]",
      eligibilityDateText: null,
      eligibleCriteriaCopy: [
        {
      ...
      tabPrefaceCopy: [],
      tooltipEligibilityText: null,
      urlSection: "specialCustodyLevelUpgrade2026PolicyV2",
      zeroGrantsTooltip: null,
    },
