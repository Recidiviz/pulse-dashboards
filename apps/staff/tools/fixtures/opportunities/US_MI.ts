  ...
  enabledConfigs: {
    ...
    usMiAddInPersonSecurityClassificationCommitteeReviewV2: {
      ...
      denialReasons: [
        ...
        {
          key: "START DATE INCORRECT",
          text: "Segregation start date is incorrect",
        },
        { key: "Other", text: "Other, please specify a reason" },
      ],
      denialText: null,
      ...
      strictlyIneligibleCriteriaCopy: [
        {
          key: "usMiOneYearSinceLastAddInPersonSccReview",
          text: "Next ADD in-person review due on or before {{date nextSccDueDate}}",
          tooltip:
            "ADDs shall personally interview each prisoner in their respective regions who has been confined in administrative segregation for twelve continuous months. If the prisoner continues in administrative segregation beyond the first twelve month period, the ADD shall interview the prisoner every twelve months thereafter until the prisoner is released from administrative segregation.",
        },
      ],
      ...
      denialReasons: [
        {
          ...
          text: "Child abuse prevention order filed during supervision period",
        },
        {
          key: "SUSPECTED OFFENSE",
          text: "Suspected of a felony, assaultive misdemeanor, OWI, or offense requiring SORA registration",
        },
        {
          key: "FELONY/STATE PROBATION",
          text: "On parole and also on other state or federal probation supervision for an offense committed during the current period",
        },
        {
          key: "NEEDS",
          text: "On parole and all criminogenic needs have not been addressed",
        },
        {
          key: "NONCOMPLIANT",
          text: "Not compliant with the order of supervision",
        },
        {
          key: "PROGRAMMING",
        ...
        {
          key: "RESTITUTION",
          text: "Has not completed court-ordered restitution payments",
        },
        {
          key: "FINES & FEES",
          text: "Willful nonpayment of restitution, fees, court costs, fines, and other monetary obligations despite clear ability to pay",
        },
        { key: "PENDING CHARGES", text: "Pending felony charges/warrant" },
        {
          key: "ORDERED TREATMENT",
          text: "Has not completed all required treatment",
        },
        {
          key: "EXCLUDED OFFENSE",
          text: "On parole for an offense resulting in death or serious bodily injury or an offense involving the discharge of a firearm",
        },
        {
          key: "EXCLUDED CURRENT OFFENSE",
          text: "On probation for MCL 750.81 or MCL 750.84, for an offense requiring a mandatory probation term (750.411H, 750.411I, 750.136b, 400.1501), or for a sex offense",
        },
        {
          key: "EXCLUDED NEW OFFENSE",
          text: "A new offense while on probation that is a felony, assaultive misdemeanor, or requires SORA registration",
        },
        {
          key: "JUDGE",
    ...
    usMiPastFTRD: {
      ...
      tabGroups: [
        {
          key: "ELIGIBILITY STATUS",
          tabs: ["Overdue", "Upcoming", "Pending", "Overridden"],
        },
      ],
      tabPrefaceCopy: [],
    ...
    usMiSecurityClassificationCommitteeReviewV2: {
      ...
      subcategoryHeadings: [
        {
          subcategory: "Administrative Segregation",
          text: "Administrative Segregation",
        },
    ...
    usMiWardenInPersonSecurityClassificationCommitteeReviewV2: {
      ...
      strictlyIneligibleCriteriaCopy: [
        {
          key: "usMiSixMonthsSinceLastWardenInPersonSccReview",
          text: "Next Warden in-person review due on or before {{date nextSccDueDate}}",
          tooltip:
            "Wardens shall personally interview each prisoner in their respective facilities who has been confined in administrative segregation for six continuous months. If the prisoner continues in administrative segregation beyond the first six month period, the Warden shall interview the prisoner every six months thereafter until the prisoner is released from administrative segregation.",
        },
      ],
