...
export const mockApiOpportunityConfigurationResponse = {
  enabledConfigs: {
    usIaEarlyDischarge: {
      ...
      companionOpportunityTypes: ["usIaSupervisionLevelDowngrade"],
      stateCode: "US_IA",
      subcategoryHeadings: [],
    ...
    usIaSupervisionLevelDowngrade: {
      ...
      eligibleCriteriaCopy: [
        {
          key: "usIaSupervisionFeesPaid",
          text: "Paid supervision fees",
          tooltip: "",
        },
        {
          key: "usIaEDDeniedFinesAndFees",
          text: "Not eligible for Eagly Discharge due to unpaid Fines and Fees",
          tooltip: "",
        },
      ],
      emptyTabCopy: [],
      ...
      ineligibleCriteriaCopy: [
        {
          key: "usIaSupervisionLevelDowngradeAlmostEligibleCriteria",
      ...
      snooze: { defaultSnoozeDays: 30, maxSnoozeDays: 90 },
      snoozeCompanionOpportunityTypes: [],
      companionOpportunityTypes: ["usIaEarlyDischarge"],
      stateCode: "US_IA",
      subcategoryHeadings: [],
      subcategoryOrderings: [],
      subheading: null,
