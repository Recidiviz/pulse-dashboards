  ...
  enabledConfigs: {
    ...
    usIdExpandedCRC: {
      ...
      denialReasons: [
        ...
        { key: "ESCAPE_ABSCONSION", text: "Prior escape or absconsion" },
        { key: "SEX_OFFENSE", text: "Prior sex charge" },
      ],
      denialText: null,
      deniedTabTitle: null,
    ...
    usIdOverdueFaceToFaceContact: {
      ...
      dynamicEligibilityText: "are overdue for a face to face contact",
      eligibilityDateText: null,
      eligibleCriteriaCopy: [
        {
          key: "usIdMeetsOverdueFaceToFaceContactAlert",
          text: "Client has not been seen in {{daysToYearsMonthsPast (daysPast lastContactDate)}}",
        },
      ],
      emptyTabCopy: [],
      firestoreCollection: "US_ID-overdueFaceToFaceContactReferrals",
      hideDenialRevert: false,
      highlightCasesOnHomepage: false,
      highlightedCaseCtaCopy: null,
      homepagePosition: 9,
      ineligibleCriteriaCopy: [],
      initialHeader: "These clients are overdue for a face to face contact.",
      isAlert: true,
      markSubmittedOptionsByTab: [],
      methodologyUrl:
        "https://drive.google.com/file/d/1pum9mrOIvGoBIwwE3dQEITod7O5mcYGm/view?usp=sharing",
      ...
      notifications: [
        {
          body: "{{opportunity.person.displayName}} has not been seen in {{daysToYearsMonthsPast (daysPast record.eligibleCriteria.usIdMeetsOverdueFaceToFaceContactAlert.lastContactDate)}}",
          id: "ee541e63-06b8-4ae1-b7a3-6ceae579d4af",
          pages: ["supervisionSupervisor", "profile"],
          type: "alert",
        },
        {
          body: "so and so opp has been shared with your supervisor",
          id: "561033ae-bbfb-4ae8-995c-ca3e2bb146d7",
          pages: ["profile"],
          type: "info",
        },
      ],
      ...
      snooze: { defaultSnoozeDays: 15, maxSnoozeDays: 30 },
      snoozeCompanionOpportunityTypes: [],
      stateCode: "US_ID",
      strictlyIneligibleCriteriaCopy: [],
      subcategoryHeadings: [],
      ...
      tabPrefaceCopy: [],
      tooltipEligibilityText: null,
      urlSection: "overdueFaceToFaceContact",
      zeroGrantsTooltip: null,
    },
    ...
    usIdTransferToCRCLikeBed: {
      ...
      eligibleCriteriaCopy: [
        ...
        {
          key: "usIdNoAbsconsionEscapeAndEludingPoliceOffensesWithin10Years",
          text: "No escape attempts in the last 10 yearsNo escape, eluding police, or absconsion offense(s) in the last 10 years",
        },
        {
          key: "usIdNotDetainersForXcrcAndCrc",
          text: "No active felony detainers or holdsCannot have any felony detainers or holds",
        },
        {
          key: "usIdNotServingARiderSentence",
          text: "Not serving for a rider sentence",
        },
        {
          ...
          text: "Is currently housed in SICI, ICIO or is releasing to a relevant districtFor SICI, the release district must be D3–D7. For ICIO, the individual must be male and releasing to D1 or D2.",
        },
        {
          key: "usIdCrcWorkReleaseTimeBasedCriteria",
          text: "Resident satisfies the time-based criteriaFor individuals serving low-severity risk crimes, eligibility is met if either of the following is true: - The EPRD (Earliest Possible Release Date) is in the past, and - The TPD (Tentative Parole Date) is between 6 and 12 months away OR - The EPRD equals the TPD, and - The TPD is between 6 and 12 months away For individuals serving high-severity risk crimes, eligibility is met if either of the following is true: - The FTRD (Full Term Release Date) is within the next 6 months OR - The EPRD (Earliest Possible Release Date) is in the past, and - The TPD (Tentative Parole Date) is within the next 6 months",
        },
      ],
      emptyTabCopy: [],
