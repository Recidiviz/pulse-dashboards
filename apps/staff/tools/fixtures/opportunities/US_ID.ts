  ...
  enabledConfigs: {
    LSU: {
      ...
      denialReasons: [
        ...
        { key: "VIOLATION_REPORT", text: "New or pending violation report" },
        {
          ...
          text: "Has not started required community service",
        },
    ...
    earnedDischarge: {
      ...
      denialReasons: [
        ...
        {
          key: "COMMUNITY_SERVICE",
          text: "Has not completed required community service",
        },
        { key: "Other", text: "Other, please specify a reason" },
      ],
      denialText: null,
    ...
    usIdOverdueFaceToFaceContact: {
      ...
      subcategoryOrderings: [],
      subheading:
        "This alert helps staff identify clients who are past overdue for a face to face contact and should be prioritized for a contact.",
      submittedTabTitle: null,
      supportsIneligible: false,
