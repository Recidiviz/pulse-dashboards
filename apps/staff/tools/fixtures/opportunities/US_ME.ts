      ...
      eligibleCriteriaCopy: [
        {
          ...
          text: 'At least {{#if (eq record.usMeIncarcerationPastRelevantClassificationDate.reclassType "ANNUAL")}}6{{else}}12{{/if}} months since last reclassification{{#if record.usMeIncarcerationPastRelevantClassificationDate.latestClassificationDate}}: {{record.usMeIncarcerationPastRelevantClassificationDate.latestClassificationDate}}{{/if}}',
          tooltip:
