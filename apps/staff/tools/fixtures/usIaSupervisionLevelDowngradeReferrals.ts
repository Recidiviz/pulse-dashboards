...
export const usIaSupervisionLevelDowngradeReferralsFixture = fixtureWithIdKey<
  UsIaSupervisionLevelDowngradeRecord["input"]
>("externalId", [
  {
    stateCode: "US_IA",
    externalId: "001",
      ...
      "Violation Incidents Dated Within the Past 6 Months": [
        {
          ...
          noteBody: "The client calls and continues to move her appointments",
