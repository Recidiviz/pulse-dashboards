...
export type UsTxAnnualReportStatusDraftData = {
  ...
  supervisingOfficerRecommendCheck: boolean;
  supervisingOfficerSignature: string;
  supervisingOfficerRemarks: string;
  unitSupervisorName: string;
  unitSupervisorConcurWithSupervisingOfficerCheck: boolean;
  ...
  paroleSupervisorConcurWithSupervisingOfficerCheck: boolean;
  ...
  assistantRegionDirectorConcurWithSupervisingOfficerCheck: boolean;
  ...
  regionDirectorConcurWithSupervisingOfficerCheck: boolean;
