...
export const MiPopulationFilterOptions: PopulationFilters = {
  ...
  [FILTER_TYPES.SUPERVISION_LEVEL]: {
    ...
    options: [
      { label: "All", value: "ALL" },
      { label: "Minimum Telephone Reporting", value: "LIMITED" },
      { label: "Minimum", value: "MINIMUM" },
      { label: "Medium", value: "MEDIUM" },
      { label: "Intensive", value: "HIGH" },
      { label: "Maximum", value: "MAXIMUM" },
      { label: "Absconsion", value: "ABSCONSION" },
    ],
    get defaultOption(): FilterOption {
...
export const NcPopulationFilterOptions: PopulationFilters = {
  ...DefaultPopulationFilterOptions,
};
...
const FilterOptions: Record<PathwaysTenants | "US_DEMO", PopulationFilters> = {
  ...
  [US_NC]: NcPopulationFilterOptions,
