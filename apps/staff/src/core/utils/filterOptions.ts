...
export const NyPopulationFilterOptions: PopulationFilters = {
  ...
  [FILTER_TYPES.FACILITY]: {
    ...
    options: [
      { label: "All", value: "ALL" },
      { label: "Adirondack", value: "1" },
      { label: "Albion", value: "2" },
      { label: "Altona", value: "4" },
      { label: "Attica", value: "6" },
      { label: "Auburn", value: "7" },
      { label: "Bare Hill", value: "8" },
      { label: "Bedford Hills", value: "11" },
      { label: "Cape Vincent", value: "18" },
      { label: "Cayuga", value: "19" },
      { label: "Clinton", value: "21" },
      { label: "Collins", value: "22" },
      { label: "Coxsackie", value: "23" },
      { label: "Downstate", value: "24" },
      { label: "Eastern", value: "25" },
      { label: "Edgecombe", value: "26" },
      { label: "Elmira", value: "27" },
      { label: "Fishkill", value: "28" },
      { label: "Five Points", value: "29" },
      { label: "Franklin", value: "30" },
      { label: "Gouverneur", value: "32" },
      { label: "Gowanda", value: "33" },
      { label: "Great Meadow", value: "34" },
      { label: "Green Haven", value: "35" },
      { label: "Greene", value: "36" },
      { label: "Groveland", value: "37" },
      { label: "Hale Creek", value: "38" },
      { label: "Hudson", value: "39" },
      { label: "Lakeview", value: "40" },
      { label: "Lincoln", value: "41" },
      { label: "Livingston", value: "42" },
      { label: "Marcy", value: "44" },
      { label: "Midstate", value: "46" },
      { label: "Mohawk", value: "47" },
      { label: "Moriah", value: "49" },
      { label: "Ogdensburg", value: "51" },
      { label: "Orleans", value: "53" },
      { label: "Otisville", value: "54" },
      { label: "Queensboro", value: "56" },
      { label: "Riverview", value: "57" },
      { label: "Rochester", value: "58" },
      { label: "Shawangunk", value: "59" },
      { label: "Sing Sing", value: "60" },
      { label: "Southport", value: "61" },
      { label: "Sullivan", value: "62" },
      { label: "Taconic", value: "64" },
      { label: "Ulster", value: "65" },
      { label: "Upstate", value: "66" },
      { label: "Wallkill", value: "67" },
      { label: "Washington", value: "68" },
      { label: "Watertown", value: "69" },
      { label: "Wende", value: "70" },
      { label: "Willard", value: "71" },
      { label: "Woodbourne", value: "72" },
      { label: "Wyoming", value: "73" },
    ],
    get defaultOption(): FilterOption {
      return this.options[0];
    },
