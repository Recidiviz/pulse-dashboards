...
import fortyEightHourNoticeTemplate from "./48_hour_notice_of_classification_review.docx";
import p1 from "./assets/p1.png";
import p2 from "./assets/p2.png";
import p3 from "./assets/p3.png";
import p4 from "./assets/p4.png";
import p5 from "./assets/p5.png";
import classificationReviewFormTemplate from "./classification_review_form.docx";
...
const formDownloader = async (
  ...
  const fileInputs: FileGeneratorArgs[] = [
    [
      `${displayName} - Classification Review Form.docx`,
      classificationReviewFormTemplate,
      contents,
    ],
    [
      `${displayName} - 48 Hour Notice Of Classification Review.docx`,
      fortyEightHourNoticeTemplate,
      contents,
    ],
  ];
