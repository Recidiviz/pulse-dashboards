...
export interface FormTextAreaProps<DraftData> extends TextareaAutosizeProps {
  name: Extract<keyof DraftData, string>;
}

const DOCXFormTextArea = observer(function DOCXFormTextArea<DraftData>({
  name,
  ...props
}: FormTextAreaProps<DraftData>) {
...
export default DOCXFormTextArea;
