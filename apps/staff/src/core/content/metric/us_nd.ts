...
const content: StateSpecificMetricCopy = {
  prisonPopulationOverTime: {
    ...
    note: "CPPs are included in the incarceration population. In this over-time chart, counts represent events from the first day of each month. This is different from the other charts on the page, which reflect counts as of the date specified in the chart title.",
  },
  ...
  supervisionPopulationOverTime: {
    note: "Interstate compact cases are included in the parole population. In this over-time chart, counts represent events from the first day of each month. This is different from the other charts on the page, which reflect counts as of the date specified in the chart title.",
    methodology:
