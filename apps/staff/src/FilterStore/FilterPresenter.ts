...
/**
 * A presenter that is used with a WorkflowsFilterDropdown.
 */
export interface FilterPresenter<T extends FilterStoreBase = FilterStoreBase> {
  readonly filterStore: T;
