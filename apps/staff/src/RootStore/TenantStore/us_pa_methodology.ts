...
export const US_PA_METHODOLOGY: LanternMethodology = {
  ...
  recommitmentsBySex: [
    ...
    {
      id: 2,
      methodology: `"Pennsylvania Population" refers to the number of individuals of the selected sex divided by the total number of people in Pennsylvania, according to the US Census Bureau. This value stays the same regardless of whether any filters are selected on the page.`,
    },
    {
      id: 3,
      methodology: `The "Supervision Population" refers to the number of individuals of the selected sex divided by the total number of people on parole supervision during the selected time period. `,
    },
    {
      id: 4,
      methodology: `"Recommitted Population" refers to the number of individuals of the selected sex who were recommitted on a board action to an SCI, CCC, or Contract Facility from parole divided by the total number of people recommitted on a board action to an SCI, CCC, or Contract Facility from parole during the selected time period. Counts do not include (1) people with Parole Violator Pending status - recommitments for these individuals are counted on the date their status changes to Convicted Parole Violator or Technical Parole Violator; (2) people who are serving a State Indeterminate Punishment sentence; (3) people recommitted for treatment in a CCC or Contract Facility.`,
    },
    {
      id: 5,
      methodology: `If a specific district is selected, "Recommitted population" and the "Parole Population" will only include individuals currently assigned to or terminated by an agent from that district.`,
    },
    {
      id: 6,
      title: "Filtering by violation history",
  ...
  recommitmentsByRace: [
    {
      id: 1,
      title: "What this chart shows",
      methodology: `When no violation history filters are selected in the "Recommitments by violation history" plot, this chart shows the percent of people in each race who were recommitted, on supervision, and in Pennsylvania's general population. At a high level, comparing these percentages can indicate whether a given race is over- or under-represented when compared to the broader population. If an individual has more than one race recorded from different data systems, they are counted toward the least common race in the state. For example, if the individual is Caucasian and African American, they would count in the African American selection because there are fewer African Americans than Caucasians in the state. If an individual does not have a known race, they are excluded from this chart.`,
    },
    {
      id: 2,
      methodology: `"Pennsylvania Population" refers to the number of individuals of the selected race divided by the total number of people in Pennsylvania, according to the US Census Bureau. This value stays the same regardless of whether any filters are selected on the page.`,
    },
    {
      id: 3,
      methodology: `The "Supervision Population" refers to the number of individuals of the selected race divided by the total number of people on parole supervision during the selected time period`,
    },
    {
      id: 4,
      methodology: `"Recommitted Population" refers to the number of individuals of the selected race who were recommitted on a board action to an SCI, CCC, or Contract Facility from parole divided by the total number of people recommitted on a board action to an SCI, CCC, or Contract Facility from parole during the selected time period. Counts do not include (1) people with Parole Violator Pending status - recommitments for these individuals are counted on the date their status changes to Convicted Parole Violator or Technical Parole Violator; (2) people who are serving a State Indeterminate Punishment sentence; (3) people recommitted for treatment in a CCC or Contract Facility.`,
    },
    {
      id: 5,
      methodology: `If a specific district is selected, "Recommitted Population" and the "Supervision Population" will only include individuals currently assigned to or terminated by an agent from that district.`,
    },
    {
      id: 6,
      title: "Filtering by violation history",
      methodology: `If the user has filtered the page by clicking on a specific violation type (i.e., low technical) or bubble (i.e., low technical and three violation reports) within the "Recommitments by violation history" plot, the groups of "Recommitted Population" and "Supervision Population" groups will be updated. If a user selected the row "Low tech.", the denominator of "Recommitted Population" will now only be people who were recommitted with a most serious violation of low technical, and the numerator would be the subset of people who are of the selected race and who have been recommitted with a most serious violation of a low technical. Similarly, with the above example, the "Supervision Population" denominator would now be all people on parole who committed a low technical violation, whether or not they were recommitted, and the numerator would be the subset of that population who were of the specified race. For people who have not been recommitted, the most serious violation is identified by considering all violations reported within one year from either the current date (if the person is still on parole) or the date that the person was discharged from parole.`,
    },
  ],
  filteredCaseTable: [
    {
