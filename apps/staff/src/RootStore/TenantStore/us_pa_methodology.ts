...
export const US_PA_METHODOLOGY: LanternMethodology = {
  ...
  recommitmentsByRace: [
    ...
    {
      id: 2,
      methodology: `"Pennsylvania Population" refers to the number of individuals of the selected race/ethnicity divided by the total number of people in Pennsylvania, according to the US Census Bureau. This value stays the same regardless of whether any filters are selected on the page.`,
    },
    {
      id: 3,
      methodology: `The "Supervision Population" refers to the number of individuals of the selected race/ethnicity divided by the total number of people on parole supervision during the selected time period`,
    },
    {
      id: 4,
      methodology: `"Recommitted Population" refers to the number of individuals of the selected race/ethnicity who were recommitted on a board action to an SCI, CCC, or Contract Facility from parole divided by the total number of people recommitted on a board action to an SCI, CCC, or Contract Facility from parole during the selected time period. Counts do not include (1) people with Parole Violator Pending status - recommitments for these individuals are counted on the date their status changes to Convicted Parole Violator or Technical Parole Violator; (2) people who are serving a State Indeterminate Punishment sentence; (3) people recommitted for treatment in a CCC or Contract Facility.`,
    },
    {
      id: 5,
