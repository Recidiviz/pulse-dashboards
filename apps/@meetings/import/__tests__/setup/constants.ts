...
export const TEST_CNI_EMPLOYMENT_FILE_NAME = `${TEST_STATE_CODE}/${CNI_EMPLOYMENT_FILE_NAME}`;
export const TEST_CNI_HOUSING_FILE_NAME = `${TEST_STATE_CODE}/${CNI_HOUSING_FILE_NAME}`;
