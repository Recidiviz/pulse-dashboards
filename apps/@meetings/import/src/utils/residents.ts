...
export async function transformAndLoadResidentData(
  ...
  for await (const residentData of data) {
    const newResident = {
      ...
      givenNames: residentData.full_name.given_names,
      middleNames: residentData.full_name.middle_names,
      surname: residentData.full_name.surname,
      suffix: residentData.full_name.name_suffix,
