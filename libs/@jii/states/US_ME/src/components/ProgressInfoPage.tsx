...
import { EligibilityCopyWrapper } from "./CopyWrapper/EligibilityCopyWrapper";
...
export const ProgressInfoPage: FC = () => {
  ...
  return (
    <InfoPage
      heading={progressPage.heading}
      body={progressPage.body}
      CopyWrapperOverride={EligibilityCopyWrapper}
    />
  );
};
