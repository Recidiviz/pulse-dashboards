...
export function PageMoreInformationEarnedCredit() {
  ...
  return (
    <DefinitionPage
      backLinkProps={{
        ...
        children: t(($) => $.moreInformation.pages.earnedCredit.backLink),
      }}
      heading={t(($) => $.moreInformation.pages.earnedCredit.heading)}
      body={t(($) => $.moreInformation.pages.earnedCredit.body)}
    />
  );
}
