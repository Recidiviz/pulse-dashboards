...
export const SentencingAssessmentReport: React.FC<SentencingAssessmentReportProps> =
  observer(function SentencingAssessmentReport({ presenter }) {
    ...
    const clientChips = (
      <Styled.RowFlexContainer gap={CHIP_GAP}>
        <Styled.ReportChip>
          Gender: {presenter.formattedGender}
        </Styled.ReportChip>
        <Styled.ReportChip>
