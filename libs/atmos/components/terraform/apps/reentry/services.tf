...
resource "google_service_account" "default" {
  ...
  display_name = "Reentry Service Account for data import and running the server"
}
...
resource "google_pubsub_topic" "reentry_export_success_topic" {
  name    = "reentry_export_success"
  project = var.project_id
