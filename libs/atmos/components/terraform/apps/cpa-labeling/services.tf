resource "google_service_account" "default" {
  account_id   = "cpa-labeling-${local.environment}"
  display_name = "Service Account for CPA Labeling server"
}
...
# This grants access to ALL Cloud SQL instances in the project (including reentry)
...
# Service account for Cloud Run CMEK encryption
...
# CMEK encryption key for Cloud SQL
