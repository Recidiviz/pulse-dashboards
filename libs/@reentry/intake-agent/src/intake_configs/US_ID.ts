...
/**
 * [READ ME]: when making changes to these sections, please also update the version number in US_ID_CONFIG below.
 */
export const US_ID_SECTIONS: Sections = [
  {
    ...
    requiredInformation: `
      ...
      3. Does the client have a government-issued ID or a driver's license issued by the DMV within the past 10 years?
         a. If the client has a driver's license:
            i. Has the license been suspended or revoked?
      ...
      7. Is this the client's first time being released from prison?
  ...
  },
  {
    ...
    requiredInformation: `
      1. Does the client have a short-term plan for a safe and confirmed place to go immediately upon release?
         a. If yes, what is the nature of that housing?
            i. If with family or friends:
               ...
               5. Is there a housing agreement (e.g. lease) that limits how long the client can stay?
      ...
      7. Does the client have no-contact orders that affect where they can live?
         a. If yes:
            i. What are the details of the order?
  ...
  },
  {
    ...
    requiredInformation: `
      ...
      2. What is the client's past work experience prior to incarceration?
         a. Does the client still have a good relationship with any prior employers?
      3. Did the client work any jobs during incarceration?
         a. If yes:
            i. Which job(s)?
            ii. Does the client have good relationships with any prior bosses who could write a letter of recommendation or act as a reference?
    `,
  },
  {
    title: "Education",
    ...
    requiredInformation: `
      ...
      2. Has the client completed any educational or vocational programming while incarcerated?
         a. If yes:
            i. What programming?
            ii. Has the client received their GED, college credits, or any other kind of diploma or credentials while incarcerated?
      3. Is the client currently enrolled in any courses or programs, such as CBISUA, at the facility?
         a. If yes:
            i. What courses or programs?
      4. Does the client have any degrees or professional certifications?
  ...
  },
  {
    ...
    requiredInformation: `
      ...
      5. Has the client previously received Social Security benefits (SSI/SSDI)?
  ...
  },
  {
    ...
    requiredInformation: `
      1. Who is part of the client's primary family?
         ...
         b. Does the client feel these family members are supportive?
      2. What are the client's goals regarding relationships with family after release?
         a. If applicable, is the client planning to reunify with their family?
         b. What specific challenges do they anticipate and how do they plan to navigate them?
      3. Does the client have children?
         a. If yes:
      ...
      4. Are there any court-ordered restrictions on contact or visitation that may affect the client's ability to be involved with their children or other family members?
         a. If yes:
            i. What are the details of the order(s)?
  ...
  },
  {
    ...
    requiredInformation: `
      1. Who are the most supportive people in the client's life?
         a. How does the client plan on connecting with these people after release?
      2. What is the nature of the client's friendships and social network?
         a. Do they feel their current social circle will be supportive of their reentry goals?
      3. Is the client interested in developing new, positive social connections?
  ...
  },
  {
    ...
    requiredInformation: `
      1. What social and recreational activities does the client enjoy?
         a. How does the client plan to participate in these activities after release?
      2. What former activities, if any, does the client plan to avoid after release?
    `,
  },
  {
    ...
    requiredInformation: `
      ...
      2. Is the client interested in starting or continuing treatment support after release?
         a. If yes:
            i. What type of support do they feel would be most effective for them now (e.g., group meetings like AA/NA, individual counseling, medication-assisted treatment, residential treatment, or something else)?
    `,
  },
];
