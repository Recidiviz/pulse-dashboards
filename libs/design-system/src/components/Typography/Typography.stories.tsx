...
import { TYPOGRAPHY_LEVELS } from "../../styles/typography";
import {
  Body12,
  Body14,
  Body16,
...
const components: Record<
  (typeof TYPOGRAPHY_LEVELS)[number],
...
/**
 * Styled-component exports that apply the typography styles to a `<div>`.
 * These mirror the `typography.*` css helpers but encapsulate them as reusable
 * components with `displayName`s preserved for debugging.
 */
const meta: Meta = {
  title: "Shared/Design System/Components/Typography",
