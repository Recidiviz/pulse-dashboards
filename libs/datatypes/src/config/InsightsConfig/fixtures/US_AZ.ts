...
export const US_AZ: InsightsConfig = {
  actionStrategyCopy: {
  ...
  metrics: [
    ...
    },
    {
      ...
      outcomeType: "ADVERSE",
      titleDisplayName: "Technical and New Crime Incarceration Rate",
      bodyDisplayName: "technical and new crime incarceration rate",
      eventName: "technical and new crime incarcerations",
      eventNameSingular: "technical and new crime incarceration",
      eventNamePastTense: "had a technical or new crime incarceration",
      descriptionMarkdown:
