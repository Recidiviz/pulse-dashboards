...
export const usMeFurloughReleaseSchema = opportunitySchemaBase.extend({
  eligibleCriteria: z
    .object({
      usMeThreeYearsRemainingOnSentence: eligibleDateReasonSchema,
      ...
      usMeNoDetainersWarrantsOrOther: z
        ...
        .nullable(),
      usMeServedHalfOfSentence: eligibleDateReasonSchema.optional(),
    })
    .passthrough(),
  metadata: z.object({ denial: usMeDenialMetadataSchema }),
});

export type UsMeFurloughReleaseRecord = ParsedRecord<
