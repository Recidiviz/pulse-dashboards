...
export * from "./people/Client/US_MO/metadata/fixture";
export * from "./people/Client/US_MO/metadata/schema";
...
export * from "./people/Resident/US_AR/metadata/fixtures";
export * from "./people/Resident/US_AR/metadata/schema";
export * from "./people/Resident/US_AZ/fixtures";
export * from "./people/Resident/US_AZ/metadata/fixtures";
export * from "./people/Resident/US_AZ/metadata/schema";
export * from "./people/Resident/US_CO/fixtures";
export * from "./people/Resident/US_CO/metadata/fixtures";
export * from "./people/Resident/US_CO/metadata/schema";
...
export * from "./people/Resident/US_NC/metadata/fixtures";
export * from "./people/Resident/US_NC/metadata/schema";
export * from "./people/Resident/US_ND/fixtures";
export * from "./people/Resident/US_ND/metadata/fixtures";
export * from "./people/Resident/US_ND/metadata/schema";
export * from "./people/Resident/US_NE/fixtures";
export * from "./people/Resident/US_NE/metadata/fixtures";
export * from "./people/Resident/US_NE/metadata/schema";
export * from "./people/Resident/US_TN/fixtures";
export * from "./people/Resident/US_TN/metadata/fixtures";
export * from "./people/Resident/US_TN/metadata/schema";
...
export * from "./parole/fixture";
export * from "./parole/schema";
