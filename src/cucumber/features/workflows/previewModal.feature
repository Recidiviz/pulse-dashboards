Feature: Interact with the preview modal on the opportunity page
    ...
    Scenario Outline: Viewing the Preview Modal
     ...
     Examples:
        | stateCode | officerName    | personName   | opportunityType     | criteriaText                | detailsText               | buttonText         |
    ...
    Scenario Outline: Update eligibility from preview modal
     ...
     Examples:
        | stateCode | opportunityType     | checkboxValue | personName   | officerName   |
    ...
    Scenario Outline: Navigate to form from preview modal
     ...
     Examples:
        | stateCode | officerName    | personName   | opportunityType     | 
    ...
    Scenario Outline: Navigate to person profile from preview modal
     ...
     Examples:
        | stateCode | officerName    | personName   | opportunityType     | personID |
