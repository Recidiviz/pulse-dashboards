...
export const US_PA_METHODOLOGY = {
  ...
  admissionsByGender: [
    ...
    {
      header: "Filtering by violation history",
      body: `If the user has filtered the page by clicking on a specific violation type (i.e., low technical) or bubble (i.e., low technical and three violation reports) within the "Admissions by violation history" plot, this chart will show the percentage of people admitted with the selected violation history for each sex and risk level group among those on supervision with the same sex and risk level. For example, if the user selected the low technical row on the plot, the chart would show for men and women overall, and for each risk level, the number of people admitted whose most serious violation was a low technical, divided by the total number of people on supervision whose most serious violation was a low technical, regardless of whether they were admitted. Continuing with this example, if a user hovers over the low-risk column for women, the numerator would be all low-risk women admitted for a low technical violation and the denominator would be all low-risk women who committed a low technical violation, whether they were admitted to a DOC facility or not. Comparing these percentages will indicate whether admission practices differ between men and women. That is, whether men are more (or less) frequently admitted compared to women with the same risk level and violation history. For people who have not been admitted, the most serious violation is identified by considering all violations reported within 9 months from either the current date (if the person is still on supervision) or the date that the person was discharged from supervision.`,
    },
  ],
  admissionsByRace: [
    {
      header: "What this chart shows",
      body: `When no violation history filters are selected in the "Admissions by violation history" plot, this chart compares the percentage of people in each race/ethnicity group who were admitted, overall and broken out by risk level. Admission rates specific to race/ethnicity and risk level are calculated as follows: overall and for each risk level, the number of people of a given race/ethnicity admitted divided by the total number of people of a given race/ethnicity in that risk level group. Risk level is defined based only on the LSI-R tool and no other assessment. Those without LSI-R scores are counted in the Unassessed category. LSI-R scores above 54 are not counted. When hovering over any column, users can see the total number of people on supervision of a given race/ethnicity who were assessed at that specific risk level as the denominator and the total number of people admitted at that risk level and race/ethnicity as the numerator.`,
    },
    {
      header: "Who is included",
      body: `Counts include all people who were admitted to SCIs from parole. This includes people on parole who were admitted for non-revocation sanctions and those who were admitted for revocation. Counts do not include (1) people with Parole Violator Pending status who have been detained pending a revocation hearing but have not been legally revoked; (2) people who are serving a State Indeterminate Punishment sentence; (3) placements in Parole Violator Centers. This chart (like all charts on the page) will automatically repopulate to match whatever filter(s) the user has selected. For example, if the user has selected "District 2" from the drop-down menus at the top of the screen, this chart will automatically update to include only people from District 2.`,
    ...
    {
      header: "Filtering by violation history",
      body: `If the user has filtered the page by clicking on a specific violation type (i.e., low technical) or bubble (i.e., low technical and three violation reports) within the "Admissions by violation history" plot, this chart will show the percentage of people admitted with the selected violation history, for each race/ethnicity and risk level group among those on supervision with the same race/ethnicity and risk level. For example, if the user selected the low technical row on the plot, the chart would show overall and for each risk level, the number of people of each race/ethnicity who were admitted whose most serious violation was a low technical, divided by the total number of people on supervision of that race/ethnicity whose most serious violation was a low technical, regardless of whether they were admitted. Continuing with this example, if a user hovers over the low-risk column for Black, the numerator would be all low-risk Black people admitted for a low technical violation, and the denominator would be all low-risk Black people who committed a low technical violation, whether they were admitted to a DOC facility or not. Comparing these percentages will indicate whether admission practices differ between racial/ethnic groups—that is, whether individuals of one race/ethnicity are more (or less) frequently admitted compared to others with the same risk level and violation record. For people who have not been admitted, the most serious violation is identified by considering all violations reported within 9 months from either the current date (if the person is still on supervision) or the date that the person was discharged from supervision.`,
    },
  ],
  filteredCaseTable: [
    {
    ...
    },
    {
      ...
      body: `A summary of the most severe reported violation on each violation report filed within 9 months prior to the last reported violation before the person was admitted.`,
    },
  ],
};
