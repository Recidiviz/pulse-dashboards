...
export default {
  ...
  revocationsOverTimeChartTitle: "Number of admissions per month",
  ...
  revocationsByOfficerChartTitle: "Admissions by officer",
  revocationsByRiskLevelChartTitle: "Admissions by risk level",
  revocationsByGenderChartTitle: "Admissions by gender",
  revocationsByRaceChartTitle: "Admissions by race/ethnicity",
  caseTableTitle: "Admitted individuals",
  revocationsOverTimeChartId: "admissionsOverTime",
  revocationsMatrixChartId: "admissionsMatrix",
  revocationsByDistrictChartId: "admissionsByDistrict",
  revocationsByOfficerChartId: "admissionsByOfficer",
  revocationsByRiskLevelChartId: "admissionsByRiskLevel",
  revocationsByViolationChartId: "admissionsByViolationType",
  revocationsByGenderChartId: "admissionsByGender",
