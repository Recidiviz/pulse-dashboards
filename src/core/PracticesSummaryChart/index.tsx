...
import "./PracticesSummaryChart.scss";
...
const PracticesSummaryChart: React.FC = () => {
  const { pagePracticesStore, tenantStore } = useCoreStore();
  const { stateCode } = tenantStore;
  const { selectedMetricTimeSeries, selectedMetricId } = pagePracticesStore;
  const [hoveredId, setHoveredId] = useState(null);

  if (!selectedMetricTimeSeries)
    return <div className="PracticesSummaryChart" />;
  ...
  const goalLabelAnnotation = (annotation: any) => {
    ...
    return (
      <g className="PracticesSummaryChart__goal-label" textAnchor="end">
  ...
  return (
    <div className="PracticesSummaryChart">
...
export default observer(PracticesSummaryChart);
