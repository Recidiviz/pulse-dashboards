...
const FormCR3947Rev0518: React.FC<FormCR3947Rev0518Props> = ({ data }) => {
  const context = useContext(FormViewerContext);

  const form = transform(data);
        ...
        <FormContainer {...context}>
          ...
          <Row>
            <Item>
              ...
              <Input
                defaultValue={form.clientFullName}
          ...
          <FormBox>
            ...
            <Grid columns="75px 1fr 1fr 1fr 1fr">
              ...
              <Item as="label">
                <Checkbox
                  defaultChecked={form.supervisionType === "Probation"}
                />{" "}
            ...
            <Grid columns="75px 75px 80px 1fr 75px 1fr">
              ...
              <Input
                placeholder="Date."
                defaultValue={form.sentenceStartDate}
              />
            ...
            <Grid columns="100px 141px repeat(2, 1fr)" rows="60px">
              ...
              <Item center>
                <Item as="label">
                  <Checkbox
                    defaultChecked={form.supervisionFeeWaived === "1"}
                  />{" "}
                  Waived
                </Item>
              </Item>
          ...
          <FormBox>
            ...
            <Grid columns="20px 180px 1fr 1fr" rows="15px">
              <Item as="label" center>
                <SpecialConditionsCheckbox
                  defaultChecked={
                    form.specialConditionsAlcDrugAssessment === "1"
                  }
                />
              </Item>
              ...
              <Input
                ...
                defaultValue={
                  form.specialConditionsAlcDrugAssessmentCompleteDate
                }
              />
            </Grid>
            <Grid columns="20px 180px 1fr 1fr" rows="30px">
              <Item as="label" center>
                <SpecialConditionsCheckbox
                  defaultChecked={
                    form.specialConditionsAlcDrugTreatment === "1"
                  }
                />
              </Item>
              <Grid rows="1fr 1fr">
                ...
                <Item>
                  <Checkbox
                    defaultChecked={
                      form.specialConditionsAlcDrugTreatmentInOut ===
                      "INPATIENT"
                    }
                  />{" "}
                  In-patient{" "}
              ...
              <Input
                placeholder="Completion Date."
                defaultValue={
                  form.specialConditionsAlcDrugTreatmentCompleteDate
                }
              />
            </Grid>
            <Grid columns="20px 75px 104px 1fr 1fr" rows="30px">
              ...
              <Grid rows="1fr 1fr">
                <Item as="label">
                  <Checkbox
                    defaultChecked={form.specialConditionsCounselingType?.includes(
                      "ANGER_MANAGEMENT"
                    )}
                  />{" "}
                  Anger Management
              ...
              <Grid rows="1fr 1fr">
                <Item>
                  <Item as="label">
                    <Checkbox
                      defaultChecked={
                        form.specialConditionsCounselingType?.includes(
                          "ANGER_MANAGEMENT"
            ...
            <Grid columns="20px 180px 1fr 1fr" rows="30px">
              <Item as="label" center>
                <SpecialConditionsCheckbox
                  defaultChecked={
                    form.specialConditionsCommunityService === "1"
                  }
                />
              </Item>
              <Item>
            ...
            <Grid columns="20px 75px 1fr 1fr 1fr">
              ...
              <Grid rows="1fr 1fr 1fr">
                ...
                <Item as="label">
                  <Checkbox
                    defaultChecked={
                      form.specialConditionsProgrammingSafe === "1"
                    }
                  />
            ...
            <Grid columns="20px 180px 1fr 1fr">
              ...
              <Input
                placeholder="Completion Date."
                defaultValue={
                  form.specialConditionsProgrammingFswCompletionDate
                }
              />
            </Grid>
          </FormBox>
