...
const PracticesMethodology: React.FC = () => {
  const { currentTenantId } = useRootStore();
  // @ts-ignore TODO TS
  const { practices: practicesMethodology } = content[currentTenantId];

  return (
    <PageTemplate>
      <div className="Methodology">
        <Container className="col-md-9 col-12">
          <h1 className="Methodology__main-title">
            {practicesMethodology.title}
          </h1>
          <h2 className="Methodology__main-description">
            {practicesMethodology.description}
          </h2>
          <div className=" Methodology__toc col-md-5 col-12">
            <h5 className="Methodology__toc--header">CONTENTS</h5>
            <div className="d-flex flex-column">
              {practicesMethodology.content.map(
...
export default observer(PracticesMethodology);
