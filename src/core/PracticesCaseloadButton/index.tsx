...
import "./PracticesCaseloadButton.scss";
...
const PracticesCaseloadButton: React.FC = () => {
  ...
  return (
    <div className="PracticesCaseloadButton__button">
      <Button
        onClick={() =>
          window.open(
      ...
      >
        ...
        <Icon
          className="PracticesCaseloadButton__icon"
          kind={IconSVG.Open}
          fill={styles.white}
        />
      </Button>
...
export default observer(PracticesCaseloadButton);
