...
import { UserOnboardingPresenter } from "../../OutliersStore/presenters/UserOnboardingPresenter";
...
const OnboardingPage = observer(function OnboardingPage({
  ...
  if (!outliersOnboarding) {
    return <Navigate replace to={outliersUrl("supervision")} />;
  }
  ...
  const handleButtonClick = async () => {
    if (!isLastTab) {
      ...
      navigate(outliersUrl("supervision"));
    }
  };
...
const OutliersOnboardingPage = observer(function OutliersOnboardingPage() {
  const {
...
export default OutliersOnboardingPage;
