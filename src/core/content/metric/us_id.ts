...
const content: StateSpecificMetricCopy = {
  projectedPrisonPopulationOverTime: {
    note: "For people held in paid county jail beds, the historical total incarcerated population uses the movements file to exclude people who have entered County Jails in unpaid beds. Currently, any movement period listed with the fac_cd + lu_cd code in the list 'RTSX', 'RTUT', 'CJVS', 'CJCT' is not counted until a subsequent movement is recorded without any of those codes. This exclusion applies to this chart only.",
    methodology:
